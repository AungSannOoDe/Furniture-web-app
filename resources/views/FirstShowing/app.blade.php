...
<body>
    <header class="text-gray-600  font-montserrat sticky top-0 bg-white z-[10000]">
        <div class="max-w-7xl mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center ">
          <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0 font-poppins">
            <img src="../images/logo.png" alt="" width="50px" height="32px">
          ...
          <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base gap-x-6 justify-center font-medium">
            <a class="mr-5 hover:text-gray-900 cursor-pointer " href="{{route('user#first#Slide')}}">Home</a>
            <a class="mr-5 hover:text-gray-900 cursor-pointer" href="{{route('user#Second#Slide')}}">about</a>
            <a class="mr-5 hover:text-gray-900 cursor-pointer" href="{{route('user#third#Slide')}}">Contact us</a>
          </nav>
         <div class="space-x-5">
