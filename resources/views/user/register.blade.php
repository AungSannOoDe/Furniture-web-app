                    ...
                    <div class="px-6">
                        ...
                        <form action="" method="post">
                            <div class="mt-8">
                                ...
                                <input type="text" name="name" id="name" class="w-full px-3 py-2 outline-0 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:ring-yellow-600 focus:border-yellow-600" required>
                            </div>
                            <div class="mt-8">
                            ...
                            <div class="mt-8">
                                ...
                                <input type="text" name="email" id="email" class="w-full px-3 py-2 outline-0 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:ring-yellow-600 focus:border-yellow-600" required>
                            </div>
                            <div class="mt-8">
